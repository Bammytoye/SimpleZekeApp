...
const home = () => {
    return (
        <div>
            {/* first component */}
            <div className="pt-32 md:px-32 px-8 py-32 cursor-pointer h-[580px] shadow-xl bg-gradient-to-r from-blue-200 via-purple-700 to-pink-800 shadow-gray-300 md:rounded-br-[500px] md:rounded-tl-[300px]">
                <div className='flex flex-col justify-center items-center space-y-6 text-white'>
                    <h2 className='font-extrabold lg:text-4xl md:text-2xl text-[30px] text-center'>
                    ...
                    <div className='flex flex-col sm:flex-row md:space-x-10 lg:space-x-10 sm:justify-center space-y-3 sm:space-y-0'>
                    ...
                    <div className="pt-12 md:pt-20 flex justify-center">
                        <Image
                            src="/image/Cashout 1.png"
                            alt='HomePix'
                            width={300}
                            height={300}
                            className="w-1/2 sm:w-1/3 md:w-[300px] lg:w-[300px]"
                        />
                    </div>
            ...
            {/* second component */}
            <div className='flex justify-center items-center px-8 md:px-48 py-32'>
                <div className="flex flex-col lg:flex-row justify-between items-center space-y-5 sm:space-x-10 px-10 py-12 border shadow-2xl shadow-blue-200 rounded-tr-[100px] rounded-bl-[100px]">
                    <div className='flex flex-col justify-center items-center space-y-1 text-center border-b-2 py-4 border-gray-600 px-3 md:px-3 sm:border-b-2 lg:border-b-0 xl:border-b-0'>
                        <Image src="/image/tech.png" alt='Sign Up' width='50' height='50' />
                        <h3 className='font-bold text-gray-600 cursor-pointer'>
                            Sign Up
                        </h3>
                        <p className='text-sm text-gray-900'>
                            Create a profile and confirm your identity. It's that simple to begin your crypto journey. Let's go!!
                        </p>
                    </div>

                    <div className='flex flex-col justify-center items-center space-y-1 text-center border-b-2 border-gray-600 py-4 px-3 md:px-3 sm:border-b-2 lg:border-b-0 xl:border-b-0'>
                        <Image src="/image/tech.png" alt='Save Funds' width='50' height='50' />
                        <h3 className='font-bold text-gray-600 cursor-pointer'>
                            Save Funds
                        </h3>
                        <p className='text-sm text-gray-900'>
                    ...
                    <div className='flex flex-col justify-center items-center space-y-1 text-center px-3 md:px-3'>
                        <Image src="/image/tech.png" alt='Make Payment' width='50' height='50' />
                        <h3 className='font-bold text-gray-600 cursor-pointer'>
                            Make Payment
                        </h3>
                        <p className='text-sm text-gray-900'>
